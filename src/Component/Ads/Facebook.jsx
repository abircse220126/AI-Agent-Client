                  ...
                  >
                    {msg.role === "user" ? (
                      ...
                      <div className="space-y-3 text-sm leading-relaxed">
                        ...
                        {msg.content.type === "landing_page" && (
                          <div className="space-y-2">
                            <p>
                              <b>🛒 What They Sell:</b>{" "}
                              {msg.content.whatTheySell}
                            </p>

                            <p>
                              <b>🎯 Main Intent:</b> {msg.content.mainIntent}
                            </p>

                            <p>
                              <b>👥 Target Audience:</b>{" "}
                              {msg.content.targetAudience}
                            </p>

                            <p>
                              <b>🧠 Funnel Type:</b> {msg.content.funnelType}
                            </p>

                            <p>
                              <b>💥 Emotion Used:</b> {msg.content.emotionUsed}
                            </p>

                            <p>
                              <b>📢 CTA Strategy:</b> {msg.content.ctaStrategy}
                            </p>

                            <p>
                              <b>⚠ Weakness:</b>{" "}
                              {msg.content.weakness?.join(", ")}
                            </p>
                          </div>
                        )}

                        {msg.content.type === "facebook_ads" && (
                          <div className="space-y-2">
                            <p>
                              <b>🛒 What They Sell:</b>{" "}
                              {msg.content.whatTheySell}
                            ...
                            <p>
                              <b>📰 Headline Strategy:</b>{" "}
                              {msg.content.headlineStrategy}
                            </p>

                            <p>
                              <b>📢 CTA:</b> {msg.content.cta}
                            </p>
                            ...
                            <p>
                              <b>🧠 Funnel Structure:</b>{" "}
                              {msg.content.funnelStructure}
                            </p>

                            <p>
                              <b>📈 Marketing Angle:</b>{" "}
                              {msg.content.marketingAngle}
                            </p>

                            <p>
                              <b>⚠ Weakness:</b> {msg.content.weakness}
                            </p>
                          </div>
                        )}
                        ...
                        <p>
                          <b>🚀 Headline:</b>{" "}
                          {msg.content.highConvertingAd?.headline}
                        </p>

                        <p>
                          <b>📝 Primary Text:</b>{" "}
                          {msg.content.highConvertingAd?.primaryText}
                        </p>

                        <p>
                          <b>📄 Description:</b>{" "}
                          {msg.content.highConvertingAd?.description}
                        </p>

                        <p>
                          <b>🎯 Audience:</b>{" "}
                          {msg.content.highConvertingAd?.targetAudience}
                        </p>

                        <p>
                          <b>👤 Age:</b>{" "}
                          {msg.content.highConvertingAd?.targetAge}
                        </p>

                        <p>
                          <b>⚧ Gender:</b>{" "}
                          {msg.content.highConvertingAd?.targetGender}
                        </p>

                        <p>
                          <b>🎯 Interests:</b>{" "}
                          {Array.isArray(
                            msg.content.highConvertingAd?.interests,
                          )
                            ? msg.content.highConvertingAd.interests.join(", ")
                            : msg.content.highConvertingAd?.interests}
                        </p>

                        <p>
                          <b>💰 Budget:</b>{" "}
                          {msg.content.highConvertingAd?.budgetSuggestion}
                        </p>

                        <p>
                          <b>🖼 Image Prompt:</b>{" "}
                          {msg.content.highConvertingAd?.imagePrompt}
                        </p>
                      </div>
                    )}
                  </div>
                          ...
                          <div className="space-y-3 text-sm leading-relaxed">
                            ...
                            {msg.content.type === "landing_page" && (
                              <div className="space-y-2">
                                ...
                                <p>
                                  <b>📢 CTA Strategy:</b>{" "}
                                  {msg.content.ctaStrategy}
                                </p>

                                <p>
                                  <b>⚠ Weakness:</b>{" "}
                                  {Array.isArray(msg.content.weakness)
                                    ? msg.content.weakness.join(", ")
                                    : msg.content.weakness}
                                </p>
                              </div>
                            )}
